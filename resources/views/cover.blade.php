   ...
   <div class="container mt-5 pt-5">
       <div class="row mt-5 pt-5">
           <div class="col-sm-12 text-center mt-5 pt-5">
               <img src="assets/img/indus-logo.png" class="img-fluid " alt="Indus Logo" title="Indus Logo">
               <h1 class="display-2">Indus Express</h1>
           </div>
           <div class="col-sm-12 text-center mt-5 pt-5">
               <a href="/itemmenu"> Start Ordering <img src="assets/img/start-order.png" class="ml-2"> </a>
           </div>
           <div class="col-sm-12 text-center mt-5 pt-5">
                <img src="assets/img/brand-badge.svg" class="img-fluid">
           </div>
       </div>
   </div>
